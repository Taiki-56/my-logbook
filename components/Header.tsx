        ...
        <nav className="flex gap-8 items-start">
          <Link
            ...
            className={`flex flex-col items-start pb-1.5 ${
              isActive("/posts") ? "border-b-2 border-[#0058c3]" : ""
            }`}
          >
            <span
              className={`font-normal text-base leading-6 ${
                isActive("/posts") ? "text-[#0058c3]" : "text-[#414754]"
              }`}
            >
              {t("Header.articles")}
            </span>
          ...
          <Link
            href={`/about`}
            className={`flex flex-col items-start pb-1.5 ${
              isActive("/about") ? "border-b-2 border-[#0058c3]" : ""
            }`}
          >
            <span
              className={`font-normal text-base leading-6 ${
                isActive("/about") ? "text-[#0058c3]" : "text-[#414754]"
              }`}
            >
              {t("Header.about")}
            </span>
