...
export default function EditPostPage() {
  ...
  const [title, setTitle] = useState("The Future of AI in Design");
  const [content, setContent] = useState(
    "デザインにおける人工知能の未来は、自動化以上の意味を持っています。それは人間の為の創造力を高めるツールとしての可能性を秘めています。\n\n今日、多くのデザイナーが日常的にタスクに従事用し続ける際により効率的で直感的なプロセスに時間を割くことができるようになっています。"
  );
    ...
    <AdminSidebar>
      <div className="min-h-screen bg-[#fbf9f8]">
        ...
        <header className="bg-[#fbf9f8] border-b border-[#c1c6d7] px-6 py-4 flex items-center justify-between">
          <div>
            <h1 className="font-['Liberation_Serif:Bold'] font-bold text-[24px] text-[#1b1c1c]">{t("editTitle")}</h1>
            <p className="text-[13px] text-[#999] mt-1">Post ID: {postId}</p>
          </div>
            ...
            <div className="bg-white border border-[#c1c6d7] rounded-lg p-4">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  />
                  <div className="text-right text-[11px] text-[#999] mt-1">26/60</div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    defaultValue="デザインにおける人工知能の未来は、自動化以上の意味を持っています。"
                    placeholder={t("metaDescriptionPlaceholder")}
                    maxLength={160}
                    rows={3}
                    className="w-full px-3 py-2 text-[13px] text-[#1b1c1c] border border-[#c1c6d7] rounded resize-none"
                  />
                  <div className="text-right text-[11px] text-[#999] mt-1">32/160</div>
                </div>
              </div>
            </div>
