...
const latestArticles = [
  ...
  },
  {
    ...
    description: "Whisper APIを活用して自身の発音をリアルタイムで採点するCLIツールの紹介。",
    tags: ["English", "Tools"],
    image: "https://images.unsplash.com/photo-1546410531-bb4caa6b424d?w=256&h=160&fit=crop",
        ...
        {latestArticles.map((article, index) => (
          <Link
            ...
            className={`flex gap-6 py-6 hover:bg-[#fbf9f8] transition-colors rounded-sm -mx-2 px-2 ${
              index < latestArticles.length - 1 ? "border-b border-[rgba(193,198,215,0.5)]" : ""
            }`}>
